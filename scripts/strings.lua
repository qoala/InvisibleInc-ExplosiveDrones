...
local DLC_STRINGS =
{
	...
	OPTIONS = {
		...
		ARM_CRAZY = "ARM SEARCH DRONES (Advanced Guard Protocol)",
		ARM_CRAZY_TIP = "<c:FF8411>ARM Search DRONES</c>\nArm search drones with a proximity weapon and behavior.\nNo effect without the Advanced Guard Protocol mod.\n" .. ARM_TIP,
